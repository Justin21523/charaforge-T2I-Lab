...
class TextWatermark:
    ...
    def __init__(self):
        self.default_text = "Generated by CharaForge T2I"
...
class WatermarkManager:
    ...
    def _generate_steganography_message(
        ...
        try:
            ...
            return (
                f"Generated by CharaForge T2I at {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}"
            )
    ...
    def _generate_metadata(
        ...
        try:
            ...
            if metadata_config.get("include_timestamp", True):
                ...
                metadata["generator"] = "CharaForge T2I Lab"
            ...
            return {"generator": "CharaForge T2I Lab"}
